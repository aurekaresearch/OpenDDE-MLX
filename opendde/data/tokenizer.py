...
class AtomArrayTokenizer(object):
    ...
    def _split_standard_protein_token(self, token: Token, parent_idx: int) -> list[Token]:
        ...
        if sidechain_pairs:
            ...
            structural_tokens.append(
                self._make_structural_token(
                    ...
                    centre_atom_index=self._choose_centre_atom_index(sidechain_pairs, ["CB"]),
    ...
    def tokenize_structural(self, residue_token_array: TokenArray | None = None) -> list[Token]:
        """
