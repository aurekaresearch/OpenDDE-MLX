...
data_configs: dict[str, Any] = {
    ...
    "template": {
        ...
        "obsolete_pdbs_path": os.path.join(DATA_ROOT, "common/obsolete_to_successor.json"),
    },
    "ccd_components_file": os.path.join(DATA_ROOT, "common/components.cif"),
    "ccd_components_rdkit_mol_file": os.path.join(DATA_ROOT, "common/components.cif.rdkit_mol.pkl"),
}
